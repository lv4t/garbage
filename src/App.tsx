      ...
      <main className="w-full max-w-4xl mx-auto flex flex-col items-center text-center space-y-8">
        ...
        {isCameraOpen ? (
          <div className="w-full max-w-2xl bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-xl border border-gray-200/50 space-y-6">
            ...
            {error && (
              <div className="w-full p-3 text-red-800 bg-red-100 border border-red-400 rounded-lg flex items-center justify-between animate-slide-in" role="alert">
                ...
                <button
                  ...
                  className="p-1 ml-2 rounded-full hover:bg-red-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-red-100 focus:ring-red-500"
