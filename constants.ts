...
export const CATEGORY_DETAILS: Record<WasteCategory, WasteCategoryDetails> = {
  "Rác Hữu Cơ": {
    ...
    flashColor: "ring-amber-500/80" // Updated to use ring- prefix
  },
  "Giấy Tái Chế": {
    ...
    flashColor: "ring-blue-500/80" // Updated to use ring- prefix
  },
  "Nhựa Tái Chế": {
    ...
    flashColor: "ring-yellow-400/80" // Updated to use ring- prefix
  },
  "Kim Loại Tái Chế": {
    ...
    flashColor: "ring-gray-500/80" // Updated to use ring- prefix
  },
  "Rác Khác": {
    ...
    flashColor: "ring-gray-900/80" // Updated to use ring- prefix
  }
};